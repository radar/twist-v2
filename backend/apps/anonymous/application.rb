...
module Anonymous
  class Application < Hanami::Application
    configure do
      ...
      #
      sessions :cookie, secret: ENV['ANONYMOUS_SESSIONS_SECRET']
      ...
      # Configure the code that will yield each time Anonymous::Action is included
      ...
      # Configure the code that will yield each time Anonymous::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Anonymous::Assets::Helpers
      end
    end
