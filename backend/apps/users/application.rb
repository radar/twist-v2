...
module Users
  class Application < Hanami::Application
    configure do
      ...
      #
      sessions :cookie, secret: ENV['USERS_SESSIONS_SECRET']
      ...
      # Configure the code that will yield each time Users::Action is included
      ...
      # Configure the code that will yield each time Users::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Users::Assets::Helpers
      end
    end
