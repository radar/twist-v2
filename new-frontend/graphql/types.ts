...
/** Autogenerated input type of Close */
...
/** Autogenerated input type of Open */
...
/** Autogenerated input type of Submit */
...
export const SubmitNoteDocument = gql`
  ...
  note: submitNote(
    input: {bookPermalink: $bookPermalink, elementId: $elementId, text: $text}
  ) {
    ...note
  }
}
